...
function buildChildrenwearMasterPrompt(input = {}) {
  ...
  return [
    ...
    '7. Protect all non-product pixels and protected scene elements from image 2 except where replacing its garment physically requires a clean boundary or contact shadow.',
    '',
    'OUTPUT:',
