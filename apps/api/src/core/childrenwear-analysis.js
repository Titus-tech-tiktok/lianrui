...
const ROLE_PROMPTS = Object.freeze({
  product: [
    ...
    'Analyze this real photographed SKU as product identity evidence. The photo may be casual, rotated, folded or contain more than one coordinated component. Do not treat its pose or background as the desired ecommerce presentation.',
    ...COMMON_RULES,
    'Required JSON shape:',
    '{"schema_version":"1.0","asset_role":"real_product","summary":"","category_guess":"","piece_count":1,"pieces":[{"piece_id":"piece_1","piece_type":"","visible_side":"front|back|side|uncertain","base_colors":[{"name":"","hex_estimate":"","coverage":0.0}],"material":{"family":"","surface":"","thickness":"","drape":"","stretch":"","sheen":"","opacity":"","wrinkle_character":""},"construction":{"silhouette":"","panels":[],"openings":[],"closures":[],"pockets":[],"seams":[],"neckline":"","sleeves":"","cuffs":"","waist":"","crotch":"","legs":"","hems":"","bindings":[],"trims":[]},"decorations":[{"id":"","type":"print|embroidery|applique|patch|label|other","description":"","visible_text":"","position":{"x":0.0,"y":0.0},"relative_size":0.0}]}],"must_preserve":[],"uncertain_regions":[{"region":"","reason":"","instruction":"do not invent"}]}',
    'Inventory every garment component separately. Preserve exact component count, visible structure, material behaviour, colours, motif/label count and relative locations.'
  ].join('\n'),
  flat_reference: [
    'CHILDRENSWEAR_FLAT_PRESENTATION_REFERENCE_ANALYSIS',
    'Analyze this finished ecommerce image only as a target flat-lay presentation blueprint. The garment shown is not the target SKU and none of its colour, material, print, label, pocket or construction may become product identity.',
    ...COMMON_RULES,
    'Required JSON shape:',
    '{"schema_version":"1.0","asset_role":"flat_presentation_reference","summary":"","canvas":{"aspect_ratio":"","width":0,"height":0,"crop":"","background":{"type":"","colors":[],"texture":""}},"presentation":{"viewpoint":"","product_count":1,"centers":[{"x":0.0,"y":0.0}],"coverage":0.0,"rotations_degrees":[],"display_pose":"","visual_outline":"","symmetry":"","spacing":""},"folds":[{"region":"","direction":"","intensity":""}],"lighting":{"direction":"","contrast":"","softness":"","color_temperature":""},"shadow":{"type":"","direction":"","softness":"","opacity":""},"protected_scene_elements":[],"preserve_from_reference":[],"replace_from_reference":[],"uncertain_regions":[]}',
    'Extract canvas, crop, product occupancy, placement, rotation, spreading/folding logic, fold directions, background, camera, lighting, shadows and any protected non-product pixels.'
  ].join('\n'),
  model_reference: [
    'CHILDRENSWEAR_MODEL_REFERENCE_ANALYSIS',
    'Analyze this model ecommerce image only as the target person, pose, crop, scene, lighting, garment deformation and occlusion blueprint. The original garment is not product identity and must be replaceable.',
    ...COMMON_RULES,
    'Required JSON shape:',
    '{"schema_version":"1.0","asset_role":"model_reference","summary":"","canvas":{"aspect_ratio":"","crop":"","camera":""},"model":{"age_band":"","body_orientation":"","pose":"","weight_bearing":"","limbs":[],"hands":[],"feet":[]},"garment_display":{"target_regions":[],"fit":"","drape":"","folds":[],"visible_regions":[],"hidden_regions":[]},"occlusions":[{"occluder":"","target_region":"","layer_order":""}],"protected_regions":[],"editable_regions":[],"scene":{"background":"","props":[]},"lighting":{"direction":"","contrast":"","softness":"","color_temperature":""},"uncertain_regions":[]}',
  ...
  combination_reference: [
    ...
    'Analyze this ecommerce composition only as a multi-SKU layout blueprint. Products shown in it are placeholders and must not contribute garment identity.',
    ...COMMON_RULES,
    'Required JSON shape:',
    '{"schema_version":"1.0","asset_role":"combination_reference","summary":"","canvas":{"aspect_ratio":"","background":{"type":"","colors":[],"texture":""}},"slot_count":2,"slots":[{"slot_id":"slot_1","center":{"x":0.0,"y":0.0},"size":{"width":0.0,"height":0.0},"rotation_degrees":0,"z_index":1,"display_pose":"","crop":""}],"overlaps":[{"front_slot":"","back_slot":"","region":"","amount":""}],"spacing":"","lighting":{"direction":"","softness":"","contrast":""},"shadow":{"contact_shadow":true,"overlap_shadow":true,"description":""},"protected_scene_elements":[],"mapping_rule":"one supplied SKU per slot; never merge identities","uncertain_regions":[]}',
    'Extract slot count, normalized geometry, scale, rotation, z-order, overlap, fold/crop, spacing, background, lighting and shadows. Do not describe placeholder garment design as a required output feature.'
  ].join('\n')
});
